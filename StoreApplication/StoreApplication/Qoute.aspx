<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qoute.aspx.cs" Inherits="StoreApplication.Qoute" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item">
                             <asp:LinkButton CssClass="nav-link active" ID="Logouta" runat="server" >Log Out</asp:LinkButton>
                            </li>
                        <li class="nav-item">
        ...
        <div>
            <p>List of products in user logged in's qoute table dataTable plug in</p>
        </div>
        <asp:Button CssClass="btn btn-secondary" ID="Button2" runat="server" Text="Update" />
         <asp:Button CssClass="btn btn-primary" ID="Button1" runat="server" Text="Save as PDF" />
    </form>
